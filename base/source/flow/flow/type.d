...
interface ICollection(E) : RandomAccessFinite!E, OutputRange!E
{
    ...
    */
    ...
    /** event beeing triggered when collection is about to change.
        event is cancellable see flow.flow.event.CancelableEventArgs.
     * Returns: event with args flow.flow.event.CollectionChangingEventArgs
     */
    @property ECollectionChanging!E collectionChanging();

    /** event beeing triggered when collection is about to change.
     * Returns: event with args flow.flow.event.CollectionChangedEventArgs
     */
...
/// generates code of list required by flow.flow.type.ICollection
