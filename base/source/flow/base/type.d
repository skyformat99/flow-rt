...
/** this module contains generalized types
 * Authors: Ralph A. Bariz
 * License: GNU General Public License version 3
 */
module flow.base.type;

import core.exception;
import std.traits, std.range.interfaces, std.range.primitives, std.uuid, std.datetime;

import flow.base.event;
...
interface ICollection(E) : RandomAccessFinite!E, OutputRange!E
{
    ...
    */
    ...
    /** event beeing triggered when collection is about to change.
        event is cancellable see flow.base.event.CancelableEventArgs.
     * Returns: event with args flow.base.event.CollectionChangingEventArgs
     */
    @property ECollectionChanging!E collectionChanging();

    /** event beeing triggered when collection is about to change.
     * Returns: event with args flow.base.event.CollectionChangedEventArgs
     */
...
/// generates code of list required by flow.base.type.ICollection
