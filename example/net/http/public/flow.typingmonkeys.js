define("flow.typingmonkeys", ["flow", "backbone", "underscore", "text!flow.typingmonkeys.html"], function(Flow, Bb, _, tpl){
    ...
    Flow.Example.CommunicatingOverseerView = Bb.View.extend({
        ...
        initialize: function(entity) {
            this.entity = entity;
            this.render();
            Flow.service.addListenSource("flow.example.net.http.main.OverseerFound", entity.id);
        },
        destroy: function() {
            this.remove();
            this.unbind();
        ...
        search: function() {
            var s = {
                dataType: "flow.example.net.http.main.OverseerSearch",
                data: {
                    dataType: "flow.example.net.http.main.OverseerSearchData",
                    search: "!!"
                }
            };
        ...
        giveCandy: function(monkey) {
            var s = {
                dataType: "flow.example.net.http.main.OverseerGiveCandy",
                data: monkey
            };
            Flow.service.send(s, this.entity);
        }
    ...
    Flow.service.registerInit(function() {    
        ...
        Flow.tick.overview.register("flow.example.net.http.main.CommunicatingOverseer", Flow.Example.CommunicatingOverseerView);

        Flow.service.beginListen("flow.example.net.http.main.OverseerFound", function(s) {
